...
describe('Coverage Tests - ShouldSendDomAndLocationWhenCheckRegionBySelectorWithCustomScrollRoot', () => {
  ...
  it('should send dom and location when check region by selector with custom scroll root (@chrome)', async () => {
    await spec.visit(
      driver,
    ...
    const element = await spec.findElement(driver, '#modal-content')
    await spec.executeScript(
      driver,
