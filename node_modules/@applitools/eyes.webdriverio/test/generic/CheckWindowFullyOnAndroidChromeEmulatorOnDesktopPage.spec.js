...
describe.skip('Coverage Tests - CheckWindowFullyOnAndroidChromeEmulatorOnDesktopPage', () => {
  ...
  it('check window fully on android chrome emulator on desktop page (@mobile @native)', async () => {
    await spec.visit(
      driver,
