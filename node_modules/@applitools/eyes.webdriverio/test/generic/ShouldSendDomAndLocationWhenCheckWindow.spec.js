// should send dom and location when check window
...
describe('Coverage Tests - ShouldSendDomAndLocationWhenCheckWindow', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      vg: false,
      displayName: 'should send dom and location when check window',
      baselineName: 'ShouldSendDomAndLocationWhenCheckWindow',
    })
  })
  ...
  it('should send dom and location when check window', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      driver,
      'Applitools Eyes SDK',
      'ShouldSendDomAndLocationWhenCheckWindow',
