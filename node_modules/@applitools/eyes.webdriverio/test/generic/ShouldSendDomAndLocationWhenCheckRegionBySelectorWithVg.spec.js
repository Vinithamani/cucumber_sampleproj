// should send dom and location when check region by selector with vg
...
describe('Coverage Tests - ShouldSendDomAndLocationWhenCheckRegionBySelectorWithVg', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      ...
      displayName:
        'should send dom and location when check region by selector with vg',
      baselineName: 'ShouldSendDomAndLocationWhenCheckRegionBySelectorWithVg',
    })
  })
  ...
  it('should send dom and location when check region by selector with vg', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      driver,
      'Applitools Eyes SDK',
      'ShouldSendDomAndLocationWhenCheckRegionBySelectorWithVg',
